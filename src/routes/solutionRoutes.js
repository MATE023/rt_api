...
router.get('/solutions', async (req, res) => {
  //res.json(solutions);
  try {
    res.json(solutionsDb.getAll(req.query.page, "solution").data);
  } catch(err) {
...
router.get('/solutions/:id/questions', async (req, res) => {
    ...
    */
    try {
        res.json(solutionsDb.getMultiple(req.query.page, `SELECT * FROM question WHERE solution_id = ${req.params.id}`).data);
        } catch(err) {
...
router.get('/solutions/:id', async (req, res) => {
    ...
    try {
        res.json(solutionsDb.getSingle(req.query.page, "solution", req.params.id).data);
        } catch(err) {
